import { IThree } from "@/types/pages/layers/three";
                    ...
                    <div key={item.id} className="pb-6 border-b border-gray-200">
                        <div className="flex items-start space-x-4">
                            ...
                            <div className="flex-1">
                                <blockquote className="text-black text-lg mb-3 leading-relaxed">
                                    "{item.text}"
                                </blockquote>
                                <div className="flex items-center">
                                    {item.avatar ? (
                                        ...
                                        <div className="w-10 h-10 rounded-lg bg-gray-200 flex items-center justify-center flex-shrink-0 mr-2">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" className="w-6 h-6 text-gray-500">
